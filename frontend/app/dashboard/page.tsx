...
export default function Dashboard() {
  ...
  return (
    <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
      ...
      {/* Hero Section */}
      <section className="bg-zinc-900 border border-border rounded-2xl p-8 sm:p-12 relative overflow-hidden">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Link href="/papers/publish" className="group flex flex-col items-center bg-zinc-900/50 border border-border rounded-xl p-6 hover:bg-zinc-800/50 hover:border-primary/50 transition-all text-center">
            ...
            <h3 className="text-white font-medium">Publish a Paper</h3>
            <p className="text-sm text-muted-foreground mt-1">Upload PDF and metadata</p>
          </Link>

          <Link href="/search" className="group flex flex-col items-center bg-zinc-900/50 border border-border rounded-xl p-6 hover:bg-zinc-800/50 hover:border-primary/50 transition-all text-center">
            ...
            <h3 className="text-white font-medium">Search Directory</h3>
            <p className="text-sm text-muted-foreground mt-1">Find research output</p>
          </Link>

          <Link href="/messages" className="group flex flex-col items-center bg-zinc-900/50 border border-border rounded-xl p-6 hover:bg-zinc-800/50 hover:border-primary/50 transition-all text-center">
          ...
          <Link href={`/profile/${user?.id}`} className="group flex flex-col items-center bg-zinc-900/50 border border-border rounded-xl p-6 hover:bg-zinc-800/50 hover:border-primary/50 transition-all text-center">
      ...
      {/* Recent Uploads */}
      <section>
        <h2 className="text-2xl font-bold text-white mb-6 tracking-tight">Latest Research</h2>
        {loadingPapers ? (
          ...
          <div className="text-muted-foreground bg-zinc-900 border border-border rounded-xl p-8 text-center italic">
